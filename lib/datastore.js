...
Datastore.prototype.getCandidates = function (query, dontExpireStaleDocs, callback) {
  ...
  // STEP 2: get candidates list by checking indexes from most to least frequent usecase
  (cb) => {
    // For a basic match
    usableQueryKeys = [];
    ...
    return cb(null, this.indexes._id.getAllIt());
  }
  // STEP 3: remove all expired documents
  , function (docs) {
