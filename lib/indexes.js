...
function projectForUnique (elt) {
  ...
  if (util.isArray(elt)) { return '$d' + elt.getTime(); }
...
function Index (options) {
  ...
  this.treeOptions = { unique: this.unique, vkUnique: true, compareKeys: model.compareThings, checkValueEquality: checkValueEquality };
